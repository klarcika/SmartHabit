...
function Milestones() {
  ...
  const fetchMilestones = async () => {
    ...
    try {
      if (isOnline) {
        const response = await axios.get(`${API}/api/milestones`, {
  ...
  const getMilestoneTitle = (type) => {
    switch (type) {
      case 'half': return "Half way there!";
      case 'full': return "Mission accomplished!";
      default: return "Napredek dosežen";
    }
  };

  const filterMilestones = (ms) => {
